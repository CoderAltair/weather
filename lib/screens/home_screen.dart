...
import 'package:weathers/screens/loading_screen.dart';
import 'package:weathers/state_management/get_location/get_location_bloc.dart';
import 'package:weathers/state_management/get_weather/weather_bloc_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GetLocationBloc, GetLocationState>(
      builder: (context, state) {
        if (state is GetCurrentLocationSuccesState) {
